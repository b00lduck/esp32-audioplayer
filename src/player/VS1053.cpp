...
/*
Expected register values at boot
...
VS1053::VS1053(uint8_t _xcsPin, uint8_t _xdcsPin, uint8_t _dreqPin, uint8_t _xresetPin) : xcsPin(_xcsPin),
                                                                                          xdcsPin(_xdcsPin),
                                                                                          dreqPin(_dreqPin),
...
void VS1053::begin()
{
  ...
  //SPI Clock to 4 MHz
  VS1053_SPI = SPISettings(SPI_SPEED_PLAYER, MSBFIRST, SPI_MODE0);
