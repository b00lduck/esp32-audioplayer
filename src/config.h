...
#define IDLE_SHUTDOWN_TIMEOUT 60000 // milliseconds
#define IDLE_SHUTDOWN_FADE_LEN 10000
#define IDLE_SHUTDOWN_FADE_START (IDLE_SHUTDOWN_TIMEOUT-IDLE_SHUTDOWN_FADE_LEN)


#define SPI_SPEED_PLAYER 8000000
#define SPI_SPEED_ADMIN 25000000

#define VOLUME_CLICKS 9
#define VOLUME_CLICKS_DELAY 40
#define VOLUME 65

#define ANTENNA_GAIN mfrc522.RxGain_avg
